---
name: discuss
description: Planning interviewer mode that turns a rough idea or plan into a clear plan. Inspects the project first, then asks focused questions in short rounds (at most three per round, each with a recommended default answer) and stops once the plan is clear enough to implement. Use when starting a vague task, getting a design brief, or sharpening a rough plan before implementation.
license: Apache-2.0
metadata:
  source: https://github.com/mitsuhiko/agent-stuff/blob/main/commands/discuss.md
---
